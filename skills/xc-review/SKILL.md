...
Review structure, cross-reference consistency, evidence sufficiency, error handling, compatibility, validation coverage, and scope boundaries appropriate to `review_kind`. Code review additionally considers correctness, security, concurrency, robustness, performance, portability, and regression risk.
