...
Do not delegate another worker. If mode selection is ambiguous, a v1 envelope is not dispatch-authoritative, or a required input or capability is missing, stop with precise blocking evidence. Do not manufacture a compatible prompt, silently omit a required control, or switch modes.
