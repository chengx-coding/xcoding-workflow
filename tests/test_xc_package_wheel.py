...
def write_test_wheel(
    ...
    *,
    ...
    members = {
        ...
        "xcoding/delegation/__init__.py": b"",
        "xcoding/delegation/adapters.py": b"def load_adapter_statement():\n    return None\n",
        "xcoding/delegation/application.py": b"def prepare():\n    return None\n",
        "xcoding/delegation/capabilities.py": b"def resolve_capabilities():\n    return None\n",
        "xcoding/delegation/commands.py": b"def main():\n    return 0\n",
        "xcoding/delegation/compiler.py": b"def compile_envelope():\n    return None\n",
        "xcoding/delegation/errors.py": b"class DelegationError(Exception):\n    pass\n",
        "xcoding/delegation/json_codec.py": b"def canonical_json_bytes(value):\n    return b''\n",
        "xcoding/delegation/migration.py": b"def scan_legacy():\n    return None\n",
        "xcoding/delegation/model.py": b"SCHEMA_VERSION = 1\n",
        "xcoding/delegation/overlay.py": b"def apply_overlay():\n    return None\n",
        "xcoding/delegation/paths.py": b"def validate_path():\n    return None\n",
        "xcoding/delegation/policy.py": b"CAPABILITY_IDS = ()\n",
        "xcoding/delegation/receipt.py": b"def detached_receipt():\n    return None\n",
        "xcoding/delegation/resolver.py": b"def resolve_profile():\n    return None\n",
        "xcoding/runtime/__init__.py": b"",
        "xcoding/runtime/application.py": b"def execute():\n    return None\n",
        "xcoding/runtime/assignment.py": b"def assignment_packet():\n    return None\n",
        ...
        "xcoding/runtime/terminal.py": b"class TerminalBroker:\n    pass\n",
...
class WheelVerifierTests(unittest.TestCase):
    ...
    def test_rejects_metadata_record_and_candidate_mismatches(self) -> None:
        cases = (
            ...
            (
                {"omitted_member": "xcoding/delegation/commands.py"},
                "member_missing",
            ),
            (
                {"omitted_member": "xcoding/runtime/terminal.py"},
                "member_missing",
            ),
            (
