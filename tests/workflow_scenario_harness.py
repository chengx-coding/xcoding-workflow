...
INPUT_PATHS = (
    ...
    "skills/xc-orchestration-runtime/scripts/runtime_core.py",
    "skills/xc-orchestration-runtime/scripts/_runtime_compat/application.py",
    "skills/xc-orchestration-runtime/scripts/_runtime_compat/commands.py",
    "skills/xc-orchestration-runtime/scripts/_runtime_compat/__init__.py",
    "skills/xc-orchestration-runtime/scripts/_runtime_compat/core.py",
    "skills/xc-orchestration-runtime/scripts/_runtime_compat/query.py",
    "skills/xc-orchestration-runtime/scripts/_runtime_compat/manifest.json",
    ...
    "src/xcoding/cli.py",
    "scripts/sync_runtime_compat.py",
