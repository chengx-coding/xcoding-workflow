...
def _verify_core_metadata(members: Mapping[str, bytes], expected_tag: str) -> None:
    ...
    for required in (
        ...
        "xcoding/__main__.py",
        "xcoding/cli.py",
        "xcoding/delegation/__init__.py",
        "xcoding/delegation/adapters.py",
        "xcoding/delegation/application.py",
        "xcoding/delegation/capabilities.py",
        "xcoding/delegation/commands.py",
        "xcoding/delegation/compiler.py",
        "xcoding/delegation/errors.py",
        "xcoding/delegation/json_codec.py",
        "xcoding/delegation/migration.py",
        "xcoding/delegation/model.py",
        "xcoding/delegation/overlay.py",
        "xcoding/delegation/paths.py",
        "xcoding/delegation/policy.py",
        "xcoding/delegation/receipt.py",
        "xcoding/delegation/resolver.py",
        "xcoding/runtime/__init__.py",
        "xcoding/runtime/application.py",
        "xcoding/runtime/assignment.py",
        "xcoding/runtime/commands.py",
        "xcoding/runtime/core.py",
        "xcoding/runtime/query.py",
        "xcoding/runtime/terminal.py",
